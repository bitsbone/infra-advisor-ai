...
All implemented apps default to `https://infra-advisor-ai.bitsbone.com` and use the existing authentication, model, conversation, upload, streaming query, suggestion, and feedback endpoints. Runtime credentials are kept in memory and are never committed.
