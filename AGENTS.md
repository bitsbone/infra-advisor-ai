...
- **Feature documentation:** Every new feature must include or update public site content under `docs/src/content/docs`. Explain what the feature does, how it is operated, and how its application, AI, and infrastructure behavior is observed. Add the page to the Starlight sidebar when it introduces a new topic.
