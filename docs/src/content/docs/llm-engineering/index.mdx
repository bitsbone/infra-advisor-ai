...
<CardGrid>
  ...
  <LinkCard
    ...
    href="./multimodal/"
    description="Image + voice chat attachments — the audio cascade design, vision content parts, and tag-based instrumentation given ddtrace's text-only message schema."
  />
  <LinkCard
